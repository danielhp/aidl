...
from keras.layers import Conv2D, MaxPool2D, UpSampling2D, BatchNormalization, Input, concatenate, Conv3D, MaxPooling3D, UpSampling3D
...
def get_unet_3d(input_shape):
    ...
    conv10 = Conv3D(1, 1, 1, activation='sigmoid')(conv9)
